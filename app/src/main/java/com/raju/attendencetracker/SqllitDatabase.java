...
public class SqllitDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(" create table " + Table_1 + "(subject_key INTEGER PRIMARY KEY AUTOINCREMENT,subject_name TEXT)");
        ...
        db.execSQL(" create table " + Table_3 + "(date TEXT PRIMARY KEY,No_of_day INTEGER,Leave_type TEXT)");
    }
    ...
    public boolean checksubject(String str) {
        ...
        String[] sqlSelector = {"subject_key", "subject_name"};
    ...
    public boolean subject_inserted(String str) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
    ...
    public boolean checkleave(String date) {
        SQLiteDatabase db = getReadableDatabase();
        SQLiteQueryBuilder qb = new SQLiteQueryBuilder();
        qb.setTables(Table_3);
        String[] sqlSelector = {"date", "No_of_day", "Leave_type"};
    ...
    public boolean addleave(String date, int day, String type) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
